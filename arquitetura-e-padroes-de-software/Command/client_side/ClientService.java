...
public class ClientService {
	...
	public static void main(String args[]) {
		try {		
			...
			// Quando formos trabalhar com estas variáveis separadamente, teremos que fazer um 
			// type casting para convertê-las de Object para o tipo que 
			// realmente é de nosso interesse
			listaParametros.put("id", 123);
			listaParametros.put("nome", "Matheus");
